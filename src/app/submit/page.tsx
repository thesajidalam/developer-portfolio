          ...
          <div className="flex items-center gap-3">
            ...
            {step < 3 ? (
              <button
                type="button"
                onClick={nextStep}
                className="shine flex-1 rounded-xl bg-gradient-to-r from-indigo-500 to-sky-500 px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-indigo-500/30 transition-all hover:scale-[1.02] hover:shadow-xl hover:shadow-indigo-500/40 active:scale-95"
              >
                Continue
              </button>
            ) : (
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={s.step} className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 text-center backdrop-blur-sm">
                <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500/20 to-sky-500/10 text-sm font-bold text-indigo-300 ring-1 ring-indigo-500/20">
                  {s.step}
                </div>
