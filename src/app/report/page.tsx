  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-16 sm:px-6">
      <div className="relative overflow-hidden rounded-3xl border border-white/[0.08] bg-[#101c2d]/70 p-8">
        <div className="pointer-events-none absolute -top-16 -right-16 h-48 w-48 rounded-full bg-[#3b82f6]/12 blur-3xl" />

        <a href="/" className="text-sm text-[#7dd3fc] transition-colors hover:text-[#a8d8ff]">
          ← Back to gallery
        </a>
        <h1 className="mt-4 font-display text-2xl font-bold text-[#f8fafc]">Report a broken link</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <button
            ...
            className="shine w-full rounded-xl bg-[#3b82f6] px-4 py-3 text-sm font-semibold text-white ring-1 ring-inset ring-white/10 transition-colors hover:bg-[#60a5fa] disabled:cursor-not-allowed disabled:opacity-50"
          >
