  ...
  if (portfolios.length < 2) {
    return (
      <div className="mx-auto max-w-xl px-4 py-24 text-center sm:px-6">
        <h1 className="text-3xl font-bold text-white">Not enough portfolios</h1>
        <p className="mt-3 text-slate-400">This comparison needs at least two portfolios to render a table.</p>
        <Link
          href="/compare"
          className="mt-8 inline-block rounded-lg border border-slate-800 bg-slate-900/60 px-5 py-2.5 text-sm font-medium text-slate-300 transition-colors hover:border-indigo-500/50 hover:text-white"
        >
          Back to compare
        </Link>
      </div>
