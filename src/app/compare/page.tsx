  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <aside className="h-fit rounded-2xl border border-slate-800 bg-slate-900/60 p-5 lg:sticky lg:top-24">
          ...
          {selected.length === 0 ? (
            ...
            <ul className="space-y-2">
              {selected.map((p) => (
                <li key={p.id} className="flex items-center gap-3 rounded-xl border border-slate-800 bg-slate-950/60 p-2.5">
                  <Avatar p={p} size="sm" />
                  <div className="min-w-0 flex-1">
                  ...
                  <button
                    ...
                    className="rounded-md px-1.5 py-0.5 text-sm text-slate-400 transition-colors hover:bg-slate-800 hover:text-white"
                  >
                    ✕
                  </button>
                </li>
          ...
          <button
            ...
            className="mt-5 w-full rounded-lg bg-gradient-to-r from-indigo-500 to-sky-500 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-indigo-500/25 transition-transform hover:scale-[1.02] disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100"
          >
