...
const SELECT_CLASS =
  'h-11 w-full rounded-xl border border-white/10 bg-[#101627]/80 px-3.5 text-sm text-slate-200 outline-none transition-all focus:border-indigo-500/60 focus:ring-2 focus:ring-indigo-500/20 sm:w-auto [&>option]:bg-[#101627]'
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-white/5">
        ...
        <div className="pointer-events-none absolute top-32 left-[-5rem] h-72 w-72 rounded-full bg-blue-500/15 blur-3xl animate-float-slow [animation-delay:3s]" />
          ...
          <div className="flex flex-col gap-12 lg:flex-row lg:items-center">
            ...
            <div className="flex-1">
              ...
              <div className="animate-hero delay-3 mt-8 flex flex-wrap items-center gap-3">
                <Link
                  href="#gallery"
                  className="shine rounded-xl bg-gradient-to-r from-indigo-500 to-blue-500 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-500/30 transition-all hover:scale-[1.03] hover:shadow-xl hover:shadow-indigo-500/50 active:scale-95"
                >
                  Browse the gallery
                </Link>
                <Link
            ...
            <div className="hidden flex-1 justify-center lg:flex">
              <div className="reveal reveal-visible relative w-full max-w-sm rounded-2xl border border-white/10 bg-white/[0.03] p-6 shadow-2xl shadow-indigo-500/10 backdrop-blur-xl">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-blue-400 text-xl font-bold text-white shadow-lg shadow-indigo-500/30">
                ...
                <div className="mt-4 rounded-xl border border-dashed border-indigo-500/30 bg-indigo-500/5 p-3.5 text-center">
                  ...
                  <Link
                    href="/submit"
                    className="mt-1 inline-block text-xs font-semibold text-indigo-300 transition-colors hover:text-indigo-200"
                  >
      ...
      {potd && (
        <section className="mx-auto max-w-7xl px-4 pt-16 sm:px-6">
          <Reveal>
            <div className="relative overflow-hidden rounded-3xl border border-amber-500/20 bg-gradient-to-br from-[#191204]/40 via-[#101627]/60 to-[#101627]/60 p-6 shadow-2xl shadow-amber-500/5 sm:p-8">
      ...
      {(topReact.length > 0 || topNext.length > 0) && (
        <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6">
          <Reveal className="mb-6 flex items-center justify-between">
            ...
            <Link href="/rankings" className="text-sm font-semibold text-indigo-300 transition-colors hover:text-indigo-200">
              Full rankings →
            </Link>
          </Reveal>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 backdrop-blur-xl">
                  <div className="mb-4 flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="text-xs font-semibold text-slate-400 transition-colors hover:text-indigo-300"
                    >
                      See all →
                    </Link>
                  </div>
          ...
          <form method="get" action="/" className="glass relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-5 shadow-xl shadow-indigo-500/5 backdrop-blur-xl">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="h-12 w-full rounded-xl border border-white/10 bg-[#101627]/80 pl-10 pr-4 text-sm text-slate-200 outline-none transition-all placeholder:text-slate-500 focus:border-indigo-500/60 focus:ring-2 focus:ring-indigo-500/20"
              />
            </div>
            ...
            <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-5">
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-xl border border-white/10 bg-[#101627]/80 pl-16 pr-3.5 text-sm text-slate-200 outline-none transition-all placeholder:text-slate-500 focus:border-indigo-500/60 focus:ring-2 focus:ring-indigo-500/20"
                />
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-xl border border-white/10 bg-[#101627]/80 pl-20 pr-3.5 text-sm text-slate-200 outline-none transition-all placeholder:text-slate-500 focus:border-indigo-500/60 focus:ring-2 focus:ring-indigo-500/20"
                />
              </div>
              ...
              <div className="flex gap-2">
                <button
                  type="submit"
                  className="shine h-11 flex-1 rounded-xl bg-gradient-to-r from-indigo-500 to-blue-500 px-4 text-sm font-semibold text-white shadow-lg shadow-indigo-500/25 transition-all hover:scale-[1.02] hover:shadow-xl hover:shadow-indigo-500/40 active:scale-95"
                >
                  Apply
                </button>
                <Link
