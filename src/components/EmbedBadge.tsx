    ...
    <div className="relative inline-flex">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 z-30 mt-2 w-80 rounded-xl border border-white/10 bg-[#141b2a] p-4 shadow-2xl shadow-black/50">
            ...
            <button
              type="button"
              onClick={copy}
              className="mt-3 w-full rounded-lg bg-[#3e8bff] px-3 py-2 text-xs font-semibold text-white transition-all hover:scale-[1.02] active:scale-95"
            >
