    ...
    <div>
      {items.length > 0 ? (
        ...
        <div className="rounded-2xl border border-dashed border-white/10 bg-white/[0.02] p-16 text-center">
          ...
          <a
            href="/"
            className="shine mt-6 inline-block rounded-xl bg-[#7B337E] px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-indigo-500/25 transition-all hover:scale-105 active:scale-95"
          >
            Clear filters
          </a>
        </div>
      ...
      {hasMore && (
        <div className="mt-10 flex flex-col items-center gap-3">
          <button
            ...
            onClick={loadMore}
            disabled={loading}
            className="shine rounded-xl bg-[#7B337E] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-500/25 transition-all hover:scale-[1.03] hover:shadow-xl hover:shadow-indigo-500/40 active:scale-95 disabled:cursor-not-allowed disabled:opacity-60"
          >
