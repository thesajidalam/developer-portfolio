...
export function Logo({ className }: { className?: string }) {
  return (
    ...
    >
      <span className="relative flex h-8 w-8 items-center justify-center overflow-hidden rounded-[10px] bg-gradient-to-br from-indigo-500 via-violet-500 to-sky-400 text-white shadow-lg shadow-indigo-500/30 ring-1 ring-inset ring-white/20 transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3">
